 ...
 *  y RETIRADO (un equipo que abandonó la liga sigue visible, con todos sus
 *  partidos resueltos 3-0 en contra por abandono — ver forfeitedTeamId).
 *  INACTIVO es el único que desaparece del todo. */
